...
manipulate(
  ...
  S.betaB1.hcw2p=slider(0,.4,.15,step=.001),
  S.betaB1.p2hcw=slider(0,4,1.5,step=0.01),
  S.betaB2=slider(0,0.02,0.00515,step=0.00001),
  S.betaB3=slider(0,0.02,0.00515,step=0.00001),
...
# Save dataset
savename <- paste0("./Output/",script.name.cdi,".Rda") # Save this in a folder of your preference
