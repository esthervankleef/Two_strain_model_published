...
axis(side=1,at=(0:years)*365,labels=0:years)
axis(side=2,at=seq(0,ymax+10,25),labels=seq(0,ymax+10,25))
legendtext<-c("Baseline", "Bacterial inference (w = 0.25)","Bacterial inference (w = 0.5)",
              "Bacterial inference (w = 0.75)","Bacterial inference (w = 1)")
...
# FIGURE S4: Prevalence change in bacterial inference and mixing
par(mfrow=c(2,2),oma=c(3,1,4,1),mar=c(1,5,1,1))
